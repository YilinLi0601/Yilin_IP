...
EMA_mplus_aim12 <- EMA_mplus %>%
  ungroup() %>%
  select(ID, Group, survey_dtime, current_affect, passiveSI, activeSI, SMI, SI_any, stress_int, pos_any, stress_int, pos_int, affect_T_1, SI_T_1, affect_post_stress, affect_post_pos)
```
